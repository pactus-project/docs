...
- **State Hash** is the [state hash](/concepts/blockchain/state-hash) of the blockchain at this block.
...
[consensus parameters](/concepts/consensus/parameters), and currently set to 1000.
The first transaction in each block is the [reward transaction](/concepts/transaction/transfer/#reward-transaction).
...
- [Merkle root](/concepts/blockchain/state-hash/#merkle-tree) hash of transactions (32 bytes)
...
[consensus protocol](/concepts/consensus/protocol) document.
