...
The previous [block hash](/docs/concepts/blockchain/block/#block-hash) in the genesis block sets to 0,
...
- **Consensus Parameters**: The initial [consensus parameters](/docs/concepts/consensus/parameters)
...
- **Treasury Account**: The [treasury account](/docs/concepts/blockchain/account/#treasury-account)
